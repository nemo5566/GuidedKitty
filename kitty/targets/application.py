...
class ApplicationTarget(GuidedTarget):
    ...
    def __init__(self, name, path, args, sancov_path=None, env=None, tempfile=None, timeout=2, logger=None):
        '''
        ...
        '''
        super(ApplicationTarget, self).__init__(name, logger, sancov_path=sancov_path)
        self.path = path
        self.args = args
        self.env = env
